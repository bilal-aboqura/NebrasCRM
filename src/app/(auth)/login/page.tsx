  ...
  return (
    <main className="grid min-h-screen place-items-center px-4 py-10">
      <section className="w-full max-w-md rounded-3xl border border-nebras-gold/30 bg-white p-7 shadow-xl sm:p-10" aria-labelledby="login-title">
        <div className="mb-8 text-center"><BrandLogo size="lg" className="mx-auto mb-4" /><h1 id="login-title" className="text-3xl font-extrabold text-nebras-green">مرحباً بك في نبراس</h1><p className="mt-2 text-slate-600">سجّل الدخول إلى مساحة عمل شركتك</p></div>
