...
## Phase 3: User Story 1 - Create and Edit Draft Offer (Priority: P1) 🎯 MVP
...
- [ ] T024 [US3] Design revision rendering in `OffersSection.tsx` at `src/components/facilities/OffersSection.tsx` grouping offers by root chain and showing version numbers ("نسخة N")
...
**Independent Test**: Navigate to "العروض". Verify Sales User A only sees active offers of assigned facilities, while Supervisor A sees all. Filter by "Draft" and verify total sum updates.
