...
- [ ] T003 Write SQL migration file at `supabase/migrations/20260621000000_reports_prerequisites.sql` to correct the `followup_type` enum and add structured fields (`event_type`, `old_value`, `new_value`) to `facility_activity`
