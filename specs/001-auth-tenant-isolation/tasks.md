...
## Phase 3: User Story 1 - Secure Arabic Login & Scoped Dashboard (Priority: P1) 🎯 MVP

**Goal**: Authenticate users via email/password and redirect them to a dashboard displaying their company name.

**Independent Test**: Log in with Company A credentials and verify the landing page renders "نبراس الجودة" as the active tenant.
...
## Phase 4: User Story 2 - Strict Tenant Data Isolation (Priority: P1) 🎯 MVP
...
**Independent Test**: Super Admin switches company to "تقنية الارتقاء" and all dashboard views update to show "تقنية الارتقاء" details.
