...
- [X] T002 Add pipeline navigation link "Ù„ÙˆØ­Ø© Ø§Ù„Ù…Ø¨ÙŠØ¹Ø§Øª" to the app shell in src/components/Sidebar.tsx
...
- [X] T003 Create database migration file for lost_reason and status_changed_at in supabase/migrations/20260616000005_pipeline_lost_reason.sql
